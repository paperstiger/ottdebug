...
void ReadMapDataset() 
{
   ...
   ROS_WARN("Finished read map dataset");
   std::cout << "size is " << cloudMap.size() << std::endl;
...
{     
      ...
      // This is commented by GAO to avoid this...
      // else{
...
int main (int argc, char** argv) {
      ...
      n.param("S/rate", _sense_rate, 10.0);

      std::string default_str;
      n.param("map/pcdfnm", _pc_fnm, default_str);
      
      ROS_WARN("sensing radius is %.3f\n", _sensing_range);
